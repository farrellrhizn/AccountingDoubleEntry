...
const EditGoalModal = ({ goal, isOpen, onClose }) => {
  ...
  useEffect(() => {
    // Update formData when goal prop changes
    setFormData(goal || { name: '', type: '', from: '', to: '', amount: '', isDashboardDisplay: false });
  }, [goal]);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Edit goal submitted:", formData);
