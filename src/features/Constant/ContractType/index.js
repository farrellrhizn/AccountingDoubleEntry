...
function ContractType() {
    ...
    return (
        <div className="p-6">
                                ...
                                <td className="py-2 whitespace-nowrap">
                                    <div className="flex space-x-2">
                                        <button
                                            ...
                                            onClick={() => handleOpenEditModal({ name: 'Cost' })}
                                        >
                                            <FaEdit />
                                        </button>
            ...
            {/* Modals */}
            {isCreateModalOpen && <CreateContractModal onClose={handleCloseCreateModal} />}
            {isEditModalOpen && <EditContractModal fieldData={selectedContract} onClose={handleCloseEditModal} />}
        </div>
    );
}
